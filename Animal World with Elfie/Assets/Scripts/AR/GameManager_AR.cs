...
public class GameManager_AR : MonoBehaviour
{
	...
	[Space(10)]
	public AudioClip[] russianQuestionClips;
	[Space(10)]
	public AudioClip[] kazakhQuestionClips;
    ...
    void GetCurrentTrackableObjects()
    {
        ...
        foreach (TrackableBehaviour tb in activeTrackables)
        {
            ...
            if (tb.TrackableName != "ActionCard" && tb.TrackableName != "groundcard" && tb.TrackableName != "ElfiBigMarker")
            {
            ...
            if (!source.isPlaying && !breakOutOfQuestions && currentTrackedTargetName != "ActionCard" && currentTrackedTargetName != "groundcard")
            {
                            ...
                            if (currentTrackedTargetName == names[randomIndex])
                            {
                                switch (currentChoosenLanguage)
                                {
                                    ...
                                    case "Chinese":
                                        ...
                                        break;
								    case "Russian":
									   source.clip = answers[4];
									    break;
									case "Kazakh":
										source.clip = answers[6];
										break;
                                    default:
                                        source.clip = answers[0];
                                        break;
                            ...
                            else
                            {
                                switch (currentChoosenLanguage)
                                {
                                    ...
                                    case "Chinese":
                                        ...
                                        break;  
								    case "Russian":
									    source.clip = answers[5];
									    break;
									case "Kazakh":
										source.clip = answers[7];
										break;  
                                    default:
                                        source.clip = answers[1];
                                        break;
        ...
        if (!source.isPlaying)
        {
            ...
            switch (currentChoosenLanguage)
            {
                ...
                case "Chinese":
                    ...
                    break;
				case "Russian":
					source.clip = russianQuestionClips[randomIndex];
					break;
				case "Kazakh":
					source.clip = kazakhQuestionClips[randomIndex];
					break;
                default:
                    source.clip = englishQuestionClips[randomIndex];
                    break;
    ...
    public void TakeScreenShot()
    {
        ...
        ScreenshotManager.SaveScreenshot("AnimalWorld-Elf_Screenshot", "Animal World with Elf", "jpeg");
